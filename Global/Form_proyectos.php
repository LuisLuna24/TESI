            ...
            <div class="Form_Registro_Titulo">
                ...
                <div class="Redes_Sociales">
                    <div class="Redes_Sociales_facebook">
                        <a href="https://www.facebook.com/TESIOficial/?locale=es_LA"><img src="img/facebook.svg" alt=""></a>
                        <label class="titulo_facebook">Facebook</label>
                    </div>
                    <div class="Redes_Sociales_youtube">
                        <a href="https://www.youtube.com/@TESIOficial"><img src="img/youtube.svg" alt=""></a>
                        <label class="titulo_youtube">Youtube</label>
                    </div>
                    <div class="Redes_Sociales_tesi">
                        <a href="https://tesi.org.mx/"><img src="img/tesi.svg" alt=""></a>
