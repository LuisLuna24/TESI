...
<body>
    <section class="form-registro">
        ...
        <input class="controls" type="text" name="Empresa o Cargo" id="Empresa o Cargo" placeholder="Ingrese su Empresa o Cargo">
        ...
        <input class="controls" type="text" name="Numero de telefono" id="Numero de telefono" placeholder="Numero de telefono">
