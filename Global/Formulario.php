...
<Section class="Registro">
        <form class="form-registro">
            ...
            <input class="controls" type="text" name="Numero de telefono" id="Numero de telefono" placeholder="Numero de telefono" onkeydown="validateInt(event)">
            <textarea class="controls" type="text" name="Mensaje" id="Mensaje" placeholder="Mensaje" onkeydown="validateInput(event)"></textarea>
            <nav>
                <input type="checkbox" name="" id="">Estoy deacuerdo con <a href="privacidad.php">Terminos y Condiciones</a></p></input>
            </nav>
            <button class="Btn_Registrar">Registrar
                <div class="star-1">
