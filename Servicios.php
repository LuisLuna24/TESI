...
==================================================================================================-->
    <section class="Servicios">
        ...
        <div class="Cards">
            <nav class="Servicios_Contenedor">
                ...
                <div class="Servicios_Card">
                    ...
                    <div class="Contenido">
                        ...
                        <p class="Card_Contenido "> •	Smart Force.<br>•	Crystal Software House.<br>•	Ilunjo S.A.</p>
                    </div>
            ...
            <nav class="Servicios_Contenedor">
                ...
                <div class="Servicios_Card">
                    ...
                    <div class="Contenido">
                        ...
                        <p class="Card_Contenido Contenido2"> 1.	Área hermética de almacenamiento para cemento. <br>2.	Área de almacenamiento para agregados básicos tales como arena y grava. <br>3.	Área de almacenamiento para acero de refuerzo. <br>4.	Tanque elevado de 1100 litros de agua potable con instalación hidráulica. <br> 5.	Pileta para curado de cilindros y vigas de prueba. <br>6.	Equipo y herramienta para las diferentes actividades.</p>
                    </div>
                    <div class="Contenido">
            ...
            <nav class="Servicios_Contenedor">
                <img class="Imagen_Servicios" src="img/img6.jpg" alt="">
                <div class="Servicios_Card">
                    <div class="Contenido">
                        <h1 class="Card_Titulo">Gestión clínica hospitalaria </h1>
...
==================================================================================================-->
    <section>
        <?php require('Global/Form_proyectos.php');?>
    </section>
<!--===============================================================================================
                                            Parte final
==================================================================================================-->
