...
<body>
    ...
    <div class="container__objetive">
     ...
     <div class="container__objetive__text__tilte">
       ...
       <div class="container__objetive__text__information">
        <p>El centro CAI busca brindar <strong>soluciones tecnológicas</strong> y mejorar las condiciones de ejecución de procesos de las empresas y distintos sectores de la zona, con el objetivo de <strong>investigar, diseñar e innovar procesos y productos,</strong> así como brindar a sus estudiantes una formación práctica con una alta pertinencia a las necesidades productivas de su entorno, buscando colocar al alcance la ciencia y tecnología para el desarrollo.<br> Con esta perspectiva es que se establece la creación del CCAl del Tecnológico de Estudios Superiores de Ixtapaluca.</p>
        <br>
        <p>El incremento de sus tareas y/o actividades, han hecho que la optimización y automatización de procesos se convierta en una de sus necesidades, en ese sentido, la creación de un centro de desarrollo e innovación tecnológica es una solución al desarrollo empresarial de la zona oriente del Estado de México, específicamente para municipios de influencia como Ixtapaluca, Amecameca, Valle de Chalco, Chalco, La Paz, Chicoloapan, Texcoco, Chimalhuacán y Nezahualcóyotl.</p>
       </div>
       </div>
    </div>
    </section>
    ...
    <section class="mision">
        <div class="container__mision">
            <div class="container__mision__text">

                <div class="container__mision__text__tite">
                    <h2>Misión</h2>
                </div>
                <div class="container__mision__text__information">
                    <p>El TESI, tiene por misión formar profesionistas competitivos con el desarrollo económico para contribuir al desarrollo del sector productivo.</p>
                </div>
            </div>
    ...
    <section class="activities">
      <div class="container__activities">
        <div class="container__activities__text">
        ...
        <div class="container__activities__cards">
            ...
            <div class="container__activities__card  card2">
                ...
                <li type="disc">Investigación colaborativa entre empresas e IES</li>
            </div>
            </div>
            ...
            <div class="container__activities__card   card3">
                ...
                <li type="disc">Promoción para que profesores desarrollen proyectos vinculados.</li>
                <li type="disc">Fuente de ingresos (recursos propios).</li>
            </div>
            </div>
