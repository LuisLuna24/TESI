...
<body>
    ...
    <section class="Cabesera">
        <div class="Cabesera_Titulo">
            ...
            <h3>Bienvenido</h3>
            <h5>PROYECTO DE CENTRO DE COOPERACIÓN ACADÉMICA – INDUSTRIA(CCAI) del <br> Tecnologico de Estudios Superiores de Ixtapalucas</h5>
        </div>
    </section>

    <section class="Titulo_Contacto">
        <h2 class="Titulo_Contacto_Titulo">Ubicación:</h2>
        <div class="Contenedor_Contenido">
            <nav class="informacion">
                <label for="">Visítanos </label>
            ...
            <nav class="boton">
                <label for="">Comunícate con nosotros, te contestaremos a la brevedad:</label>
                <button class="Btn_Registrar0">Mensaje
                    <div class="star-1">
    ...
    <section class="Redes_Sociales">
        ...
        <section class="Redes">
            <div class="Redes_Informacion">
                <label class="Redes_Informacion_Direccion">Dirección: </label>
                <label>Carretera Coatepec, Callejon San Juan 7, 56580 Ixtapaluca, Méx.</label>
            </div>

            <div class="Redes_Informacion">
                <label class="Redes_Informacion_Telefono">Teléfono: </label>
